...
public class ApiActivity extends AppCompatActivity{
    ...
    private static final String TAG = "ApiActivity ACTIVITY";
    ...
    private void getMinneapolisTemp() {
        ...
        ApiActivity.RequestMinneapolisCurrentTemp tempTask = new ApiActivity.RequestMinneapolisCurrentTemp();
    ...
    private void getMinneapolisRadar() {
        ...
        new ApiActivity.RequestMinneapolisRadarMap().execute(url);
